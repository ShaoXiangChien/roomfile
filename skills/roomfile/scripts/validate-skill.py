...
def main() -> int:
    ...
    required = [
        ...
        "references/style-atlas/index.json",
        "references/style-atlas/CONTRIBUTING.md",
        "references/style-atlas/schemas/style-pack.schema.json",
        "references/style-atlas/schemas/style-context.schema.json",
        "references/style-atlas/styles/mid-century-modern/manifest.json",
        "references/style-atlas/styles/bauhaus/manifest.json",
        "references/style-atlas/styles/japandi/manifest.json",
