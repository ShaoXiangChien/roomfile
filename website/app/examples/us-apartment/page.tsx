...
export const metadata: Metadata = {
  title: "Fictional US apartment example",
  description:
    "A complete Roomfile workflow for a fictional 650 sq ft US rental apartment.",
};

export default function UsApartmentExample() {
  return (
    <main id="main" className="case-study">
      <header className="case-hero">
        <div className="shell">
          <p className="eyebrow">Public demo · entirely fictional</p>
          <h1>A fictional US rental, remembered from first photo to final plan.</h1>
          <p className="lede">
      ...
      <section className="section">
        <div className="shell case-step">
          ...
          <div>
            <h2>Lock the rental before imagining around it.</h2>
            <p>
              The same camera, two north windows, radiator, HVAC register,
              entry swing, wood-look floor, outlets, sofa, and oak dining table
        ...
        <div className="shell case-step">
          ...
          <div>
            ...
            <div className="reaction-grid">
              <blockquote>
                “I like the wood and the lamp shape.”
                <cite>→ material warmth + one sculptural light</cite>
              </blockquote>
              <blockquote>
                “Colorful without feeling childish.”
                <cite>→ disciplined primary accents</cite>
              </blockquote>
              <blockquote>
                “Quiet, but not just beige.”
                <cite>→ texture + negative space</cite>
              </blockquote>
              <blockquote>
                “Too staged. Too many little objects.”
                <cite>→ anti-reference: decorative clutter</cite>
              </blockquote>
            </div>
          </div>
        </div>
      ...
      <section className="section">
        <div className="shell case-step">
          ...
          <div>
            <h2>Three real directions—not one layout in three colors.</h2>
            <div className="case-concepts">
              <article>
                <RoomVisual style="mid-century" compact />
                <h3>Mid-century Modern</h3>
                <p>Walnut, oatmeal, moss, sculptural light.</p>
            ...
            <p className="image-caption">
              Visual approximations—dimensions, colors, materials, and
        ...
        <div className="shell case-step">
          ...
          <div>
            ...
            <p className="image-caption">
              ...
              structured geometry remains authoritative.
            </p>
