...
All three directions preserve the same 240 × 180 in room, camera, sofa, dining table, windows, flooring, radiator, HVAC, openings, and circulation.
...
Renders are visual approximations. Selection is based on the brief, measurements, budget, sourcing evidence, and fit report as well as appearance.

These directions are examples, not presets. Roomfile can derive other
directions or additional exploration rounds from different taste evidence.
