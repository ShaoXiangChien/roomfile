...
Generated from `/Users/ericchien/Documents/Interior Design/examples/us-apartment/roomfile/rooms/living-room/concepts/japandi/render-request.json`. The JSON request remains the source of truth.

## Provider contract

- Adapter: banana
- Concept: japandi v1
- Output: `/Users/ericchien/Documents/Interior Design/examples/us-apartment/roomfile/rooms/living-room/assets/generated/japandi.png`
...
Goal: Explore a restrained Japandi alternative in the exact same fictional rental room.
...
Allowed edits only:
1. add pale-timber coffee table
2. add paper or linen-shade floor lamp
3. add removable flax and stone textiles
4. add natural-material decor and plants
5. add no-drill art
