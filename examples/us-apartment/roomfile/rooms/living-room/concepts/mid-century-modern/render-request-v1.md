...
Generated from `/Users/ericchien/Documents/Interior Design/examples/us-apartment/roomfile/rooms/living-room/concepts/mid-century-modern/render-request-v1.json`. The JSON request remains the source of truth.

## Provider contract

- Adapter: banana
- Concept: mid-century-modern v1
- Output: `/Users/ericchien/Documents/Interior Design/examples/us-apartment/roomfile/rooms/living-room/assets/generated/mid-century-modern.png`
...
Goal: Explore a Mid-century Modern direction in the exact same fictional apartment, translating the approved warm, collected, 1970s-inflected evidence while preserving every locked architectural and inventory fact.
